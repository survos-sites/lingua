...
return [
    ...
    'datatables.net-buttons-bs5' => ['version' => '4.0.2'],
    'datatables.net-buttons' => ['version' => '4.0.2'],
    'datatables.net-buttons-bs5/css/buttons.bootstrap5.min.css' => ['version' => '4.0.2', 'type' => 'css'],
    'datatables.net-responsive-bs5' => ['version' => '4.0.2'],
    'datatables.net-responsive' => ['version' => '4.0.2'],
    'datatables.net-responsive-bs5/css/responsive.bootstrap5.min.css' => ['version' => '4.0.2', 'type' => 'css'],
    ...
    'datatables.net-select-bs5' => ['version' => '4.0.1'],
    'datatables.net-select' => ['version' => '4.0.1'],
    'datatables.net-select-bs5/css/select.bootstrap5.min.css' => ['version' => '4.0.1', 'type' => 'css'],
    'datatables.net-columncontrol' => ['version' => '2.0.1'],
    'datatables.net-columncontrol-bs5' => ['version' => '2.0.1'],
    'datatables.net-columncontrol-bs5/css/columnControl.bootstrap5.min.css' => ['version' => '2.0.1', 'type' => 'css'],
    'stimulus-attributes' => ['version' => '1.0.2'],
    'escape-html' => ['version' => '1.0.3'],
    'dexie' => ['version' => '4.4.5'],
    'datatables.net-bs5/css/dataTables.bootstrap5.css' => ['version' => '3.0.3', 'type' => 'css'],
    'datatables.net-buttons-bs5/css/buttons.bootstrap5.css' => ['version' => '4.0.2', 'type' => 'css'],
    'datatables.net-responsive-bs5/css/responsive.bootstrap5.css' => ['version' => '4.0.2', 'type' => 'css'],
    'datatables.net-searchbuilder-bs5/css/searchBuilder.bootstrap5.css' => ['version' => '2.0.0', 'type' => 'css'],
    'datatables.net-select-bs5/css/select.bootstrap5.css' => ['version' => '4.0.1', 'type' => 'css'],
    'datatables.net-columncontrol-bs5/css/columnControl.bootstrap5.css' => ['version' => '2.0.1', 'type' => 'css'],
    'marked' => ['version' => '18.0.11'],
